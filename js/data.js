...
(function () {
  ...
  window.data = {
    ...
    simularAds: createAds(8)


  };

  function createAds (quantity) {
    ...
    var offerTitleCopy = dataForSimularAds.offerTitle.slice(0); // чтобы можно было удалять вытащенное, не травмируя исходные данные
    ...
    for (var i = 0; i < quantity; i++) {
      var ad = new Ad(dataForSimularAds);
      ads.push(ad);
    }
